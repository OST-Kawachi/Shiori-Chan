using ShioriChan.Services.MessagingApis.Messages.BuilderFactories.Imagemaps;
using ShioriChan.Services.MessagingApis.Messages.BuilderFactories.QuickReplies;
using ShioriChan.Services.MessagingApis.Messages.BuilderFactories.Templates;
...
namespace ShioriChan.Services.MessagingApis.Messages.BuilderFactories {
	...
	public static partial class MessageBuilderFactory {
		...
		/// メッセージBuilder
		/// </summary>
		private class MessageBuilder : IMessageFactory, IBuildOnlyMessageBuilder, ISettableVideoImagemapMessageBuilder, ISettableExternalLinkImageMapMessageBuilder {
			...
			public IMessageFactory AddMessage( string text )
				=> this;
			...
			/// <returns>ビルド可能な自身の子クラス</returns>
			public IMessageFactory AddSticker( string packageId , string stickerId )
				=> this;
			...
			/// <returns>ビルド可能な自身の子クラス</returns>
			public IMessageFactory AddImage( string originalContentUrl , string previewImageUrl )
				=> this;
			...
			/// <param name="previewImageUrl">プレビュー画像のURL</param>
			/// <returns>ビルド可能な自身の子クラス</returns>
			public IMessageFactory AddVideo( string originalContentUrl , string previewImageUrl )
				=> this;
			...
			/// <returns>ビルド可能な自身の子クラス</returns>
			public IMessageFactory AddAudio( string originalContentUrl , int duration )
				=> this;
			...
			/// <returns>ビルド可能な自身の子クラス</returns>
			public IMessageFactory AddLocation(
				string title ,
				string address ,
				double latitude ,
				double longitude
			...
			public IMessageFactory SetExternalLink( string url , string label )
				=> this;
			...
			public IMessageFactory AddFlexMessage( string altText )
				=> this;
