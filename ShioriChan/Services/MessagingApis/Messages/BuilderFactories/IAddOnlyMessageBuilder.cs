...
namespace ShioriChan.Services.MessagingApis.Messages.BuilderFactories {
	...
	public interface IAddOnlyMessageBuilder {
		...
		IMessageFactory AddMessage( string text );
		...
		/// <returns>MessageBuilder</returns>
		IMessageFactory AddSticker( string packageId , string stickerId );
		...
		/// <returns>MessageBuilder</returns>
		IMessageFactory AddImage( string originalContentUrl , string previewImageUrl );
		...
		/// <param name="previewImageUrl">プレビュー画像のURL</param>
		/// <returns>MessageBuilder</returns>
		IMessageFactory AddVideo( string originalContentUrl , string previewImageUrl );
		...
		/// <returns>MessageBuilder</returns>
		IMessageFactory AddAudio( string originalContentUrl , int duration );
		...
		/// <returns>MessageBuilder</returns>
		IMessageFactory AddLocation( string title , string address , double latitude , double longitude );
		...
		IMessageFactory AddFlexMessage( string altText );
