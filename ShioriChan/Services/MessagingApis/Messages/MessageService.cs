...
namespace ShioriChan.Services.MessagingApis.Messages {
	...
	public class MessageService : IMessageService {
        ...
        /// <returns></returns>
        public async Task<object> GetSentReplyMessageCount( DateTime replyDate ) {
            ...
            object sentReplyMessageCount = null;

            try
            {
                this.logger.LogTrace("Start Post Async");
                HttpResponseMessage response = await client.GetAsync($"https://api.line.me/v2/bot/message/delivery/reply/?date={date}" ).ConfigureAwait(false);
                this.logger.LogTrace("End Post Async");
                sentReplyMessageCount = response;
                string result = await response?.Content.ReadAsStringAsync();
                this.logger.LogTrace("Post Async Result is {result}", result.Length);
                response.Dispose();
                client.Dispose();
        ...
        /// <param name="replyDate"></param>
        /// <returns></returns>
        public async Task<object> GetSentMulticastMessageCount(DateTime replyDate)
        {
            ...
            object sentMulticastMessageCount = null;

            try
            {
                this.logger.LogTrace("Start Post Async");
                HttpResponseMessage response = await client.GetAsync($"https://api.line.me/v2/bot/message/delivery/multicast/?date={date}").ConfigureAwait(false);
                this.logger.LogTrace("End Post Async");
                sentMulticastMessageCount = response;
                string result = await response?.Content.ReadAsStringAsync();
                this.logger.LogTrace("Post Async Result is {result}", result.Length);
                response.Dispose();
                client.Dispose();
            ...
            return sentMulticastMessageCount;
        }
        ...
        /// <param name="replyDate"></param>
        /// <returns></returns>
        public async Task<object> GetSentBroadcastMessageCount(DateTime replyDate)
        {
            ...
            object sentBroadcastMessageCount = null;

            try
            {
                this.logger.LogTrace("Start Post Async");
                HttpResponseMessage response = await client.GetAsync($"https://api.line.me/v2/bot/message/delivery/broadcast/?date={date}").ConfigureAwait(false);
                this.logger.LogTrace("End Post Async");
                sentBroadcastMessageCount = response;
                string result = await response?.Content.ReadAsStringAsync();
                this.logger.LogTrace("Post Async Result is {result}", result.Length);
                response.Dispose();
                client.Dispose();
            ...
            return sentBroadcastMessageCount;
        }
    }
